    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.action_add).setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                Intent intent = new Intent(MainActivity.this, com.example.note.Add.class);
...
//                    Intent intent = new Intent(MainActivity.this, com.example.note.Research.class);
...
//        });
        ...
        ListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){      //配置ArrayList点击按钮
            ...
            public void  onItemClick(AdapterView<?> parent, View view , int position , long id){
                ...
                Intent intent = new Intent(MainActivity.this, com.example.note.Edit.class);
